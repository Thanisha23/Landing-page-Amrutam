...
const SectionFive:React.FC = () => {
  return (
    <div className='h-[2320px] pt-[62px] w-[100%] bg-[#FFFAEC]'>
        <div className=' text-[#3A643B] text-[32px] font-bold flex justify-center items-center w-[80%] mx-auto text-center pt-[61px]  '>What sets Ayurvedic consultations apart?</div>
        <Card1 />
